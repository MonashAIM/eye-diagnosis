...
Install requirements: e.g. python -m pip install -r requirements.txt  (Custom install torch, depending your current CUDA version or non-CUDA i.e. CPU. Read requirements.txt file.)
